...
class Results(Page):
    ...
    def vars_for_template(player):
        ...
        """
            ...
            msg += f"""
        <p>Now we will play a third round of the game, which will follow slightly different rules. Again, at least one person in your group needs to volunteer in order for you to earn some {units}, meaning that if no one volunteers, no one will earn any {units}. However, in this third round the volunteer will earn {cu(50)}, while the other participants will earn {cu(40)}. Only the participant who will volunteer first will earn the {cu(50)}; if you decide to volunteer but someone else has volunteered before you, you will earn {cu(40)}. This is because the volunteer will have to pay {cu(50)}, but all of the other participants will transfer 10 of their {cu(50)} to the volunteer. Imagine that your small rural community has decided that to access the community centre, residents have to pay a fee, which will be used to compensate the person who prepares the rooms and tides up afterwards.</p>
