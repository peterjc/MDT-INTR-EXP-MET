...
class Instructions(Page):
    ...
    def vars_for_template(player: Player):
        ...
        <p>
        The computer will pair you with other {C.PLAYERS_PER_GROUP - 1} participants, making a group of {C.PLAYERS_PER_GROUP}. The group will remain the same during the {C.NUM_ROUNDS} rounds. In each round, each of the members of your group has the opportunity to earn {cu(50)}. In order for the members of your group to earn the {cu(50)}, at least one of you needs to ‘volunteer’. The volunteer will have to pay a cost of {cu(50)}, meaning that they will not earn any {units} in that round. You will have {C.VOLUNTEER_TIMEOUT} seconds to decide whether to volunteer. If at least one participant in your group volunteers, everyone apart from them will earn {cu(50)}. Only the participant who volunteers first will have to pay the {cu(50)}, and thus will not earn any {units}. Those who will possibly volunteer after them will  not be considered as volunteers and will thus receive {cu(50)}. If no one volunteers, no one will earn any {units}. At the end of the {C.VOLUNTEER_TIMEOUT} seconds, you will be automatically redirected to the page with the results of that round. You will be told whether anyone has volunteered, and your total earnings in that round. You will not know the identity of the person who has volunteered.
        </p>
        {framing_msg}
        <p>
        To summarise, there are 3 options:
        <ol>
        <li>You volunteer first in your group: you will earn {cu(0)}, and the {C.PLAYERS_PER_GROUP-1} other participants will earn {cu(50)} each</li>
        <li>You volunteer but someone else volunteers first in your group: you and {C.PLAYERS_PER_GROUP-2} other participants will earn {cu(50)} while 1 other participant who volunteered first will earn {cu(0)}.</li>
        <li>None of the {C.PLAYERS_PER_GROUP} participants in your group volunteers: you and the other 5 participants will each receive {cu(0)}.</li>
        </ol>
        </p>
        <p>
...
class Volunteering(Page):
    ...
    def vars_for_template(player: Player):
        ...
        if player.round_number in [1, 2, 5]:
            # Self-less volunteer:
            instructions = f"<p>To volunteer you need to click the button before the end of the {C.VOLUNTEER_TIMEOUT} seconds. If no one in your group volunteers, all of you earn {cu(0)}. If one person volunteers, this person earns {cu(0)} and the other members of the group earn {cu(50)}. Only the person who volunteers first earns {cu(0)}: those who will possibly volunteer after them will receive {cu(50)}. At the end of the {C.VOLUNTEER_TIMEOUT} seconds, you will be automatically redirected to the page with the results of this round.</p>"
        else:
            # Compensated volunteer:
            instructions = f"<p>To volunteer you need to click the button before the end of the {C.VOLUNTEER_TIMEOUT} seconds. If no one in your group volunteers, all of you earn {cu(0)}. If one person volunteers, this person earns 50 points and the other members of the group earn {cu(40)}. Only the person who volunteers first earns {cu(50)}: those who will possibly volunteer after them will receive {cu(40)}. At the end of the {C.VOLUNTEER_TIMEOUT} seconds, you will be automatically redirected to the page with the results of this round.</p>"
...
class Results(Page):
    ...
    def vars_for_template(player: Player):
        ...
        To summarise, there are 3 options:
        <ol>
        <li>You volunteer first in your group: you will earn {cu(50)}, and the {C.PLAYERS_PER_GROUP-1} other participants will earn {cu(40)} each</li>
        <li>You volunteer but someone else volunteers first in your group: you and {C.PLAYERS_PER_GROUP-2} other participants will earn {cu(40)} while 1 other participant who volunteered first will earn {cu(50)}.</li>
        <li>None of the {C.PLAYERS_PER_GROUP} participants in your group volunteers: you and the other 5 participants will each receive {cu(0)}.</li>
        </ol>
        </p>
