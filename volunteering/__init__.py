...
class Instructions(Page):
    ...
    def vars_for_template(player: Player):
        ...
        <p>
        Do you have any questions? If so, please ask us by using the Q&A function, and the experimenter will answer your question for everyone.
        </p>
        <p>
...
class Results(Page):
    ...
    def vars_for_template(player: Player):
        ...
        <p>Do you have any questions? If so, please ask us by using the Q&A function, and the experimenter will answer your question for everyone.</p>
